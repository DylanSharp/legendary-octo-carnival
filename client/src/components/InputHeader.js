...
const InputHeader = (props) => {
    ...
    const submitHandler = (event) => {
        ...
        API.addComment(content).then((newComment) => {
        ...
        <header className="discussion__header">
            ...
            <form className="discussion__new-comment-panel" onSubmit={submitHandler}>
                ...
                <input type="text" className="discussion__new-comment-input"
                       placeholder="What are your thoughts?" onChange={contentChangeHandler}></input>
                <button className="discussion__new-comment-button" type='submit'>Comment</button>
            </form>
        </header>
    );
}
